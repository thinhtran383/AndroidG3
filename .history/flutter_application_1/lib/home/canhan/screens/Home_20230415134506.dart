...
abstract class MyBox extends Box {
  void update(int key, Function(dynamic value) updateCallback) {
    put(key, updateCallback(get(key)));
  }
}
      ...
      setState(() {
        ...
        for (var todo1 in foundToDo) {
          if (todo1.hienthi == true) {
            tasksBox.update(todo1.key, (todo2) {
              todo2.hienthi = false;
            });
          }
        }
