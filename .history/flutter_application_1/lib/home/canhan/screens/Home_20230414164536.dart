...
class _HomeState extends State<Home> {
  ...
  void initState() async {
    super.initState();
     _todoBoxEventStream = _todoBox.watch();
  _todoBoxEventStream.listen((event) {
    if (event.type == BoxEventType.put) {
      // Lấy tất cả các phần tử từ _todoBox và đặt chúng vào foundToDo
      foundToDo = _todoBox.values.toList();
      setState(() {});
    }
  });
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Stream<BoxEvent>>('_todoBoxEventStream', _todoBoxEventStream));
  }
}
