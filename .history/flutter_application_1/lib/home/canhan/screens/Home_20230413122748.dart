...
class _HomeState extends State<Home> {
  ...
  // List<ToDo> toDoListDone = [];
   List<ToDoAdapter> foundToDo = [];
  List<ToDoAdapter> toDoListDone = [];
  @override
  void initState() {
    foundToDo = ToDoAdapter.todoList();
  ...
  void onClickToDoItemDone(ToDo todo) {
    ...
    if (todo.isDone) {
      setState(() {
        ...
        _myBoxDone.put(todo.id, todo);
       

        todoList.removeWhere((todo) => todo.isDone == true);
         _myBox.delete(todo.id);
      ...
      setState(() {
        ...
        _myBox.put(todo.id, todo);
        _myBoxDone.delete(todo.id);
      });
    }
  }
  ...
  void _addToDoItem(String toDo) {
    ...
    setState(() {
      ...
      _myBox.put(DateTime.now().millisecondsSinceEpoch.toString(), ToDo(
        id: DateTime.now().millisecondsSinceEpoch.toString(),
        contentTodo: toDo,
        isDate: seconds,
        date: datenow,
