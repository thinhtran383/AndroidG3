...
class _HomeState extends State<Home> {
  ...
  void onClickToDoItemDone(todo todo) {
    ...
    if (todo.isDone == true) {
      setState(() {
        ...
        var todoToDelete =
            tasksBox.values.firstWhere((todo1) => todo1.isDone == true);
      ...
      setState(() {
        ...
        var todoToDeleteFromDone =
      toDoListDone.firstWhere((todo1) => todo1.id == todo.id, orElse: () => null);
  if (todoToDeleteFromDone != null) {
    toDoListDone.remove(todoToDeleteFromDone);
  }
  ...
  void onClickDeleteIcon(String id) {
    setState(() {
      ...
      // var todoToDelete1 = tasksBoxDone.values.firstWhere((todo1) => todo1.id == id);
