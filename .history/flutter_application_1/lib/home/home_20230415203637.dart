      ...
      case '21010627':
        fetchData(
                ...
                dayfirst < 10
                    ...
                    : monthfirst > 10
                        ? '0${dayfirst}%2F${monthfirst}%2F${yearfirst}'
                        : '0${dayfirst}%2F0${monthfirst}%2F${yearfirst}''${dayfirst}%2F0${monthfirst}%2F${yearfirst}',
                daylast < 10
                    ? monthfirst > 10
                        ? '0${daylast}%2F${monthfirst}%2F${yearfirst}'
                        : '0${daylast}%2F0${monthfirst}%2F${yearfirst}'
                    : '${daylast}%2F0${monthfirst}%2F${yearfirst}')
            .then((value) {
          setState(() {
            data = value;
          });
