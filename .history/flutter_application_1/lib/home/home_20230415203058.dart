...
class _homeState extends State<home> {
  ...
  void calculateWeekDays() {
   ...
   String formattedDayLast = daylast < 10 ? '0$daylast' : '$daylast';
String formattedDayFirst = dayfirst < 10 ? '0$dayfirst' : '$dayfirst';

    }

    switch (widget.MSV) {
      case '21010627':
        fetchData('79BE3FF1328F49A397E15EFAF4E83870', '${dayfirst}%2F0${monthfirst}%2F${yearfirst}',
        ...
        break;
      case '21010636':
        fetchData('7EEE02F6121340B98E4F0530ECB0AD84', '${dayfirst}%2F0${monthfirst}%2F${yearfirst}',
                '${daylast}%2F0${monthlast}%2F${yearlast}')
            .then((value) {
          setState(() {
            data = value;
