...
class chitiet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
       ...
       The named parameter 'decoration' isn't defined.
Try correcting the name to an existing named parameter's name, or defining a named parameter with the name 'decoration'
      child: Card(
        elevation: 5,
